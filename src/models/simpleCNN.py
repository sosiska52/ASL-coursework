...
if __name__ == "__main__":
    model = SimpleCNN(num_classes=len(loaded_data['classes']))  # используем число классов из данных
    ...
    visualizer.plot(save_path=r'D:\GitHubRepo\ASL-coursework\reports\figures\training_plot_cnn.png')
    torch.save(model.state_dict(), r"D:\GitHubRepo\ASL-coursework\src\models\simpleCNN.pth")
